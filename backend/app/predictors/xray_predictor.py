...
class XrayPredictor:
    ...
    def __init__(self):
        ...
        self.model_path = os.path.join(BASE_DIR, "ml_models", "xray", "pneumonia_model.keras")
        self.seg_model_path = os.path.join(BASE_DIR, "ml_models", "xray", "lung_segmentation_model.hdf5")
        self.model = None
        self.seg_model = None
        self.IMG_SIZE = 224
